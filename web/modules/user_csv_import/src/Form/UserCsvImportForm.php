...
class UserCsvImportForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['config_options']['roles'] = [
      ...
      '#description' => $this->t('Tick the roles the imported users shall get. The Authenticated user role is mandatory'),
    ];
    ...
    $form['config_options']['separator'] = [
      ...
      '#required' => true,
      '#default_value' => ',',
      '#description' => $this->t('The separator character is used to separate fields in the CSV-file.'),
      '#size' => 1,
      '#maxlength' => 1,
    ];
    ...
    $form['config_options']['password'] = [
      ...
      '#required' => true,
      '#description' => $this->t("The password is set to this for all imported users, unless overridden. See this module's README.md for details."),
    ...
    $form['config_options']['status'] = [
      ...
      '#description' => $this->t('Ensure this is set to Active if you want the user to be enabled.'),
    ...
    $form['config_options']['registration_email_type'] = [
      ...
      '#description' => $this->t("If sending a welcome email, ensure that <strong>Status</strong> is  set 'Active', so users are able to log in and set a password."),
    ...
    $form['config_fields']['fields'] = [
      ...
      '#description' => $this->t('Tick the fields to import by means of CSVs. The fields Name and Email will are mandatory'),
    ];
